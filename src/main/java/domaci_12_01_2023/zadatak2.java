...
public class zadatak2 {
    public static void main(String[] args) {
        ...
        Racun ana = new Racun("258-852-654","Ana Stojkovic", 5000.0);
        Racun mara = new Racun("159-753-258","Marija Stojkovic",10.0 );

        Transakcija pozajmica = new Transakcija("258",ana,mara);
        ana.stampaj();
        mara.stampaj();
        pozajmica.izvrsiTransakciju(4600);
        pozajmica.stampaj();
