...
public class zadatak1 {
    public static void main(String[] args) {
        ...
        Korpa k = new Korpa();
        Tetrapak t = new Tetrapak("2585285-987","Mleko",1.00,1.20,true,250.5);
        StaklenaAmbalaza sA = new StaklenaAmbalaza("258987-842","Pivo",850.0,900.0,50,true,120.25);

        SuperKartica sK = new SuperKartica("1598752","Ana Stojkovic",100);
        ...
        k.izbaciAmbalazu("258987-842");

        k.dodajAmbalazu(sA);

        System.out.println(k.ukupnaCena(sK));
